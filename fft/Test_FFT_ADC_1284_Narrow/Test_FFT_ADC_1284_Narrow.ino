...
void timer_setup(){
  ...
  /* TODO:
  Set timer 1 so it cycles at the sampling frequency (8 KHz) and raises an interrupt on output compare.
...
/* TODO: 
 - turn adc on and have it interrupt upon completion of conversion
 - set a prescaler of 16
 - Timer/Counter1 Compare Match B trigger src

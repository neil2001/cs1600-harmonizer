...
int crossfade() {
    ...
    if (o2 == i2) {
        ...
        // Serial.print("xf_weight: ");
        // Serial.println(xf_weight);
        // Serial.print("sample_weight: ");
        // Serial.println(sample_weight);

        int xf_val =  (int) (float(buffer_xf[out]) * sample_weight + float(buffer_xf[pos]) * xf_weight);

        // Serial.println(xf_val);
        // return buffer_xf[out];
